    ...
    <div class="container-fluid h-custom">
      <div class="row d-flex justify-content-center align-items-center h-100">
        <div class="col-md-9 col-lg-6 col-xl-5">
          <img src="https://animesher.com/orig/1/116/1163/11632/animesher.com_gatos-kawaii-anime-gif-1163226.gif"
            class="img-fluid ms-3 rounded-circle" width="500" alt="gambar animek" >
        </div>
          ...
          <form method="POST" action="{{ route('login') }}">
            ...
            <div class="d-flex justify-content-between align-items-center">
              ...
              <div class="form-check mb-0">
                <input class="form-check-input me-2" type="checkbox" value="" id="form2Example3" {{ old('remember') ? 'checked' : '' }}/>
            ...
            <div class="text-center text-lg-start mt-4 pt-2">
              ...
              <p class="small fw-bold mt-2 pt-1 mb-0" style="text-decoration: none">Don't have an account? <a href="{{route('register')}}"
